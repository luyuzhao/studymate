# -*- coding: utf-8 -*-
"""Rewrite convert_words.ps1 with proper UTF-8 BOM encoding"""
import os

content = u'''[Console]::OutputEncoding = [System.Text.Encoding]::UTF8
...
target = os.path.join(os.path.dirname(__file__), 'convert_words.ps1')
